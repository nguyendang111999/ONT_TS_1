...
public partial class @PlayerInput : IInputActionCollection2, IDisposable
{
    ...
    public @PlayerInput()
    {
        if (UnityEngine.PlayerPrefs.HasKey("rebinds"))
        {
            asset = InputActionAsset.FromJson(UnityEngine.PlayerPrefs.GetString("rebinds"));
            UnityEngine.Debug.Log(asset.ToJson());
        }
        else
        {
    ...
    ""controlSchemes"": [
        ...
        UnityEngine.PlayerPrefs.SetString("rebinds", asset.ToJson());
        UnityEngine.Debug.Log(asset.ToJson());
    }
